...
$string['admin:map:eduv'] = 'eduvidual (new school)';
...
$string['createcourse:subcat1:defaults'] = "SY24/25\nSY25/26\nPersistent";
...
$string['manage:adduser:description'] = 'Everyone in your organization (including you) can only see people that belong to your organization. In order to add a person to the domain of your organization you have to add this person using the persons individual Accesscard-ID. This Accesscard-ID (e.g. <i>1234#atan</i>) is given at the eduvidual block and the accesscard.';
...
$string['manage:createuserspreadsheet'] = 'Excel-Management';
...
$string['manage:userlist'] = 'Users in your organization';
$string['manage:bipmatching'] = 'Link with Bildungsportal';
...
$string['manage:userlist:linked:yes'] = 'Linked';
$string['manage:userlist:linked:no'] = 'Not linked';
...
$string['manage:userlist:remove:confirm'] = 'Remove {firstname} {lastname} from school?';
...
$string['manage:users:tab'] = 'Roles/Passwords';
...
$string['bip_import_schools:title'] = 'BIP: Update schools from bildung.gv.at';
$string['bip_import_users:title'] = 'BIP: Import users from bildung.gv.at';
$string['bip_match_users:title'] = 'BIP: Match users to Moodle accounts by name';
$string['bip_matching:bip_firstname'] = 'BIP first name';
$string['bip_matching:bip_lastname'] = 'BIP last name';
$string['bip_matching:bip_email'] = 'BIP email';
$string['bip_matching:bip_dateofbirth'] = 'BIP date of birth';
$string['bip_matching:bipuserid'] = 'BIP user';
$string['bip_matching:choose'] = 'choose';
$string['bip_matching:notinbip'] = 'no longer in BIP';
$string['bip_matching:source'] = 'Linked by';
$string['bip_matching:source_user'] = 'Login';
$string['bip_matching:source_automatch'] = 'Name match';
$string['bip_matching:source_manager'] = 'School';
$string['settings:bip_host'] = 'BIP API Host';
$string['settings:bip_host:desc'] = '';
$string['settings:bip_basicauth'] = 'BIP API Basic Auth';
$string['settings:bip_basicauth:desc'] = 'Credentials in the form "user:password" for the BIP API, used by the BIP import scheduled tasks.';
...
$string['registration:name:lengthexceeded:text'] = 'Sorry, the maximum length of {$a->chars} chars was exceeded. Please shorten the name.';
$string['registration:name:lengthexceeded:title'] = 'Length exceeded';
...
$string['user:merge_accounts:description'] = 'On this page you can transfer all data of an old user account to your current one (e.g. new account at new school). Please enter your old e-mail address in the following field and you will receive a secret code on that old address. With that code, you can start the transmission of your old data.<br /><br /><strong>It can take a long time until your accounts are completely merged. Please do not interrupt that process, <u>you must not reload the page or navigate somewhere else</u>!</strong>';
$string['user:merge_accounts:invalidcodeormail'] = 'Invalid code or email given';
...
$string['user:merge_accounts:sendcode'] = 'Send code';
