...
$string['admin:formmodificator:description'] = 'Hier können Sie angeben, inwiefern Formular zur Erstellung von Aktivitäten/Ressourcen entsprechend dem Erfahrungslevel angepasst werden sollen. Geben Sie den Typ der Ressource und die Rollen-ID an. In der Spalte "Verstecke" können Sie nun mit Semikolons getrennt (;) die CSS-Selektoren angeben, die ausgeblendet werden sollen. In der Spalte "Default Werte" geben Sie Wertepaare an, welche Standardwerte im Formular gesetzt werden sollen, bspw. css_selektor1=default_wert1;css_selektor2=default_wert2 usw.';
$string['admin:formmodificator:ids_to_hide'] = 'Verstecke';
$string['admin:formmodificator:ids_to_set'] = 'Default Werte';
$string['admin:formmodificator:roleid'] = 'Rollen-ID';
$string['admin:formmodificator:type'] = 'Typ';
...
$string['admin:stats:lpf_and_eduv'] = 'Alle';
$string['admin:stats:lpf'] = 'Nur LPF';
$string['admin:stats:lpfeduv'] = 'beides';
$string['admin:stats:migrated'] = 'umgestiegen';
$string['admin:stats:neweduv'] = 'Nur eduvidual';
