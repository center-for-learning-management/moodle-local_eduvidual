...
$string['manage:accesscodes:list'] = 'Erstellte Codes';
...
$string['manage:coursesettings:overridebigbluebutton:description'] = 'Diese Moodle-Instanz {$a->sitename} bietet einen BigBlueButton-Server an, der für normale Anwendungen ausreichend ist. Sollten Sie aus irgendwelchen Gründen einen alternativen BigBlueButton-Server für alle Kurse in Ihrer Organisation einstellen wollen, geben Sie bitte die Serverdaten hier ein.';
...
$string['manage:createuserspreadsheet:col:cohorts_remove'] = 'Globale Gruppe -';
$string['manage:createuserspreadsheet:col:result'] = 'Ergebnis';
$string['manage:createuserspreadsheet:import:datavalidated'] = 'Daten sind in Ordnung, sende zur Datenbank';
$string['manage:createuserspreadsheet:import:description'] = 'Sie können Nutzer/innen auf Basis eines Tabellendokuments erstellen / verwalten. Bitte verwenden Sie als Grundlage unsere <a href="{$a->urlspreadsheet}" target="_blank">Vorlage</a>, um neue Nutzer/innen einzugeben, oder ändern Sie bestehende Daten nach dem Download einer <a href="{$a->wwwroot}/local/eduvidual/pages/manage_userlists.php?orgid={$a->orgid}&cohort=___all" target="_blank">aktuellen Nutzerliste</a>.<br /><br /><a class="btn btn-primary" href="{$a->wwwroot}/local/eduvidual/pages/manage_userlists.php?orgid={$a->orgid}&cohort=___all" target="_blank">Nutzerliste exportieren</a>';
