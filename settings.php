...
if ($ADMIN->fulltree) {
    ...
    $settings->add(
        new admin_setting_configtext(
            'block_eduvidual/edutubeauthurl',
            get_string('edutube:edutubeauthurl', 'block_eduvidual'),
            '',
            '',
            PARAM_TEXT
        )
    ...
    $settings->add(
        new admin_setting_configtext(
            'block_eduvidual/edutubeauthtoken',
            get_string('edutube:edutubeauthtoken', 'block_eduvidual'),
            '',
            '',
            PARAM_TEXT
        )
