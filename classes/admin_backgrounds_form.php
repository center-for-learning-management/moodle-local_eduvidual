...
class local_eduvidual_admin_backgrounds_form extends moodleform {
    ...
    function definition() {
        global $CFG;
        $mform = $this->_form;
        $mform->addElement('filemanager', 'backgrounds', get_string('admin:backgrounds:filearealabel', 'local_eduvidual'), null,
                    array(
