...
$types = ['manager', 'teacher', 'student', 'parent'];
$roles = [
    32 => 'manager',
    33 => 'teacher',
    34 => 'student',
    ...
    if (in_array($type, $types)) {
        ...
        if (!$roleinuse) {
            ...
            if (!empty($previousrole) && $previousrole != $role) {
                ...
                $assignments = $DB->get_records('role_assignments', ['roleid' => $previousrole, 'contextid' => $context->id]);
            ...
            if (!empty($role)) {
                ...
                $members = $DB->get_records('local_eduvidual_orgid_userid', ['role' => ucfirst($type)]);
